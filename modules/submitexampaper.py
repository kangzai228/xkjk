...
import requests
def submitexampaper(Token,StudentSessionsID):
    headers = {
    ...
    json_data = {
        'StudentSessionsID': StudentSessionsID,
        'QuestionAnswers': [],
    }

    response = requests.post('https://xkjk.jxeea.cn:8000/EOAPI/studentexam/submitexampaper', headers=headers, json=json_data)
    return response.json()['Entity']['MockExam']['QuestionAnswers']
            ...
            "QuestionAnswers": [
                {
                    ...
                    "QuestionTypeSort": 1,
                    "Duration": 1,
                    "SubmitDate": "2023-10-25 12:29:26",
                    "Answers": [
                        {
                ...
                },
                {
                    ...
                    "QuestionTypeSort": 1,
                    "Duration": 1,
                    "SubmitDate": "2023-10-25 12:31:38",
                    "Answers": [
                        {
